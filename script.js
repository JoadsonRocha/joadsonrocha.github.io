...
const translations = {
  pt: {
    ...
    'mockup-hint': 'Passe o mouse para rolar',
    ...
    'btn-download-msi': 'Baixar .MSI',
    'btn-download-exe': 'Baixar .EXE',
    ...
    'project-ebookfinder-desc': 'Organizador desktop leve e 100% offline para coleções de e-books e quadrinhos (EPUB, PDF, CBZ), com extração instantânea de capas, busca em tempo real e estantes virtuais de leitura.',
    'project-localpdf-desc': 'Interface gráfica (GUI) desenvolvida em Python para carregar, visualizar e manipular documentos PDF com facilidade, sem depender de comandos no terminal e com total privacidade local.',
    'project-nexus-desc': 'Plataforma de Gestão Eleitoral, Inteligência de Campo e CRM Político de Alta Performance (Sistema Águia), integrando métricas estratégicas e lideranças.',
    'project-nextblog-desc': 'CMS moderno e visual inspirado no WordPress, com editor drag-and-drop de blocos, gestão de posts/páginas, arquitetura headless com API REST/GraphQL e IA.',
    'project-agrofacil-desc': 'Sistema inteligente para gestão de agricultura e piscicultura familiar, com monitoramento de ciclos, controle operacional e relatórios de desempenho.',
    'project-dexacomigo-desc': 'Plataforma de classificados para contratação ágil de serviços autônomos com integração inteligente e assistência por IA.',
    'project-mydailyhabits-desc': 'Aplicação interativa para acompanhamento de hábitos diários, consistência e rotinas produtivas com interface minimalista e intuitiva.',
    'project-com1site-desc': 'Iniciativa para criação e desenvolvimento de sites institucionais, landing pages de alta performance e soluções de presença digital moderna para marcas.',
  ...
  en: {
    ...
    'btn-download-msi': 'Download .MSI',
    'btn-download-exe': 'Download .EXE',
    'btn-releases': 'Releases',
    ...
    'project-ebookfinder-desc': 'Lightweight, 100% offline desktop manager for e-books and comic books (EPUB, PDF, CBZ) with instant cover extraction, live search, and virtual bookshelves.',
    'project-localpdf-desc': 'Python-developed GUI for loading, viewing, and manipulating PDF documents easily and offline without relying on terminal commands.',
    'project-nexus-desc': 'Electoral Management, Field Intelligence & High-Performance Political CRM Platform (Sistema Águia) integrating strategic metrics and grassroots analytics.',
    'project-nextblog-desc': 'Modern WordPress-inspired visual CMS featuring a block-based drag-and-drop editor, post/page management, headless REST/GraphQL API, and AI.',
    'project-agrofacil-desc': 'Smart management platform for family farming and fish farming, tracking production cycles, operational controls, and performance metrics.',
    'project-dexacomigo-desc': 'Classifieds marketplace for freelance and home service contractors powered by intelligent AI assistance.',
    'project-mydailyhabits-desc': 'Interactive habit tracker for building daily routines, consistency, and productivity goals with a clean, minimalist UI.',
    'project-com1site-desc': 'Web initiative focused on building high-conversion landing pages, brand websites, and digital modern solutions.',
