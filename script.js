...
const translations = {
  pt: {
    ...
    'dashboard-desc': 'Confira o painel de estudos e acompanhamento diário de metas e rotinas.',
    ...
    'cv-role': 'Gestor em TI & Desenvolvedor Full Stack • Especialista em Projetos Ágeis',
    'cv-summary-title': 'Resumo Executivo',
    'cv-summary-text': 'Profissional multidisciplinar com sólida formação em Gestão em Tecnologia da Informação aliada a licenciaturas em Pedagogia, História e Física. Criador e mantenedor de produtos SaaS e soluções open-source de alta performance com milhares de acessos, incluindo StratisPlanner, RiseMindr, Mestrio, Lumina e MultDownload. Especialista em metodologias ágeis (Scrum, Kanban, Jira), com ampla vivência em arquitetura de software, desenvolvimento Full Stack (JavaScript, TypeScript, React, Node.js, Python, Electron) e liderança focada em entrega de valor e experiência do usuário.',
    ...
    'cv-skills-title': 'Competências Técnicas & Gestão',
  ...
  en: {
    ...
    'dashboard-desc': 'Check out the study dashboard and daily tracking of goals and routines.',
    ...
    'cv-role': 'IT Manager & Full Stack Developer • Agile Project Specialist',
    'cv-summary-title': 'Executive Summary',
    'cv-summary-text': 'Multidisciplinary professional with strong background in IT Management combined with degrees in Pedagogy, History, and Physics. Creator and maintainer of high-performance SaaS products and open-source solutions with thousands of users, including StratisPlanner, RiseMindr, Mestrio, Lumina, and MultDownload. Specialist in Agile methodologies (Scrum, Kanban, Jira), with deep expertise in software architecture, Full Stack development, and value-driven leadership.',
    ...
    'cv-skills-title': 'Technical & Management Skills',
