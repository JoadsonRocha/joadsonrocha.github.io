...
const translations = {
  pt: {
    ...
    'header-subtitle': 'Gestor em TI & Desenvolvedor Full Stack • Especialista em Projetos Ágeis • Formado em Pedagogia, História e Física • Apaixonado por Open Source',
  ...
  en: {
    ...
    'header-subtitle': 'IT Manager & Full Stack Developer • Agile Specialist • Degree in Pedagogy, History, and Physics • Open Source Enthusiast',
